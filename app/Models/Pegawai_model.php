...
class Pegawai_model extends Model
{
    ...
    public function getPegawaisatpam()
    {
        return $this->db->table($this->table)
        ->join('r_jenis_ptk', 'r_jenis_ptk.id_jenis_ptk = t_ptk.id_jenis_ptk')
        ->where('nama_jenis_ptk', 'Satpam')
        ->orderBy('nama_ptk')
        ->get()->getResultArray();
    }
    public function getPegawaikary()
    {
        return $this->db->table($this->table)
    ...
    {
        return $this->db->table($this->table)
        ->select('t_ptk.*, r_jenis_ptk.nama_jenis_ptk')
        ->join('r_jenis_ptk', 'r_jenis_ptk.id_jenis_ptk = t_ptk.id_jenis_ptk', 'LEFT')
    ...
    public function getPegfilter($jenis)
    { 
        return $this->db->table($this->table)
        ->select('t_ptk.id_ptk as id_ptk,nama_ptk,nomor_absensi,nip,nama_jenis_ptk')
        ->join('r_jenis_ptk', 'r_jenis_ptk.id_jenis_ptk = t_ptk.id_jenis_ptk')
    ...
    public function getPegawaishift()
    {
        ...
        ->WhereNotIn('id_ptk', static function (BaseBuilder $builder) {
            $builder->select('id_ptk')->from('jadwal_khusus');
        })
        ->join('r_jenis_ptk', 'r_jenis_ptk.id_jenis_ptk = t_ptk.id_jenis_ptk')
        ->get()->getResultArray();
    }
    ...
    public function editPegawainip($data, $id)
    {
        $builder = $this->db->table($this->table);
