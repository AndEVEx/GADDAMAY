            ...
            <div class="navbar-content scroll-div">
                <div class="">
					<div class="main-menu-header">
                        ...
                        <?php }elseif(session()->get('level')==2){ ?>
                            <img class="img-radius" src="<?=base_url()?>/image/guru/<?=session()->get('foto');?>" alt="User-Profile-Image">
                        <?php }else{ ?>
                            <img class="img-radius" src="<?=base_url()?>/image/siswa/<?=session()->get('foto');?>" alt="User-Profile-Image">
                        <?php } ?>
					...
					<div class="collapse" id="nav-user-link">
                        ...
                        <?php }elseif((session()->get('level'))==3){ ?>
                            <li class="list-group-item"><a href="<?= base_url('Siswaprofile'); ?>"><i class="feather icon-user m-r-5"></i>View Profile</a></li>
                        <?php } ?>
                ...
                <ul class="nav pcoded-inner-navbar">
                    ...
                    <li class="nav-item pcoded-hasmenu">
                        <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-airplay"></i></span><span class="pcoded-mtext">Info Absensi Guru</span></a>
                    ...
                    <li class="nav-item pcoded-hasmenu">
                        <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-box"></i></span><span class="pcoded-mtext">Data Master Guru</span></a>
                        <ul class="pcoded-submenu">
                    ...
                    <li class="nav-item pcoded-hasmenu">
                        <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-check"></i></span><span class="pcoded-mtext">Ijin</span></a>
                        <ul class="pcoded-submenu">
                            <?php 
                            ...
                            ?>
                            <li><a href="<?= base_url('Approveijin'); ?>">Approve Guru <span class="badge badge-danger"><?= $jml_ijin ?></span></a></li>
                            <li><a href="<?= base_url('Approveijinsiswa'); ?>">Approve Siswa <span class="badge badge-danger"><?= $jml_ijinsiswa ?></span></a></li>
                    ...
                    <?php }elseif((session()->get('level'))==2){ ?>
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('Ajukanizin'); ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-upload"></i></span><span class="pcoded-mtext">Ajukan Izin</span></a>
                        </li>
                        <?php 
                        ...
                        ?>
                        <li class="nav-item pcoded-hasmenu">
                            <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-airplay"></i></span><span class="pcoded-mtext">Wali Kelas</span></a>
                            <ul class="pcoded-submenu">
                    ...
                    <li class="nav-item">
                        <a href="<?= base_url('Ajukanizinsiswa'); ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-upload"></i></span><span class="pcoded-mtext">Ajukan Izin</span></a>
                    </li>
                    <?php } ?>
