                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        ...
                                        <form method="post" action="<?= base_url('Absensisiswa/koreksiwali'); ?>">
                                                ...
                                                <table id="example" class="table table-striped table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if($stsabsen=='Alpha' || empty($jammasuk) || empty($jampulang)){?>
                                                                ...
                                                                <?php }else{ ?>
                                                                    <button class="btn btn-success btn-sm" type="submit" disabled><i class="feather icon-edit-2"></i></button>
                                                              ...
                                                              <div class="modal fade" id="editmasuk<?=$id ?>">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <!-- Modal body -->
                                                                    <form method="post" action="<?= base_url('Absensisiswa/updatemasukwali'); ?>">
                                                              ...
                                                              <div class="modal fade" id="edittidak<?=$id ?>">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <!-- Modal body -->
                                                                    <form method="post" action="<?= base_url('Absensisiswa/updatetidakmasukwali'); ?>">
                                                                        <div class="modal-body">
                                                                            <div class="row">
