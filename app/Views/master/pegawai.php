                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if(empty($data['photo'])){?>
                                                                    <img class="img-thumbnail" src="<?=base_url()?>/image/guru/noimage.png" width="50">
                                                                <?php }else{ ?>
...
<!-- Modal body -->
<form class="was-validated" method="post" action="<?= base_url('Pegawai/add'); ?>" enctype="multipart/form-data">
    <div class="modal-body">
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
