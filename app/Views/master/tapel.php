                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select class="form-control" name="sts" required>
                                                                                        <option>Pilih</option>
                                                                                        <option value="1" <?php if($data['sts_aktif']==1) { ?> selected="" <?php } ?>>Aktif</option>
                                                                                        <option value="0" <?php if($data['sts_aktif']==0) { ?> selected="" <?php } ?>>Tidak Aktif</option>
                                                                                    </select>
                                                                                </div>
                                                                            </div>
                                                                            </div>
