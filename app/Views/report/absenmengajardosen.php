                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="card">
                                        ...
                                        <form method="post" action="<?= base_url('Absendosen'); ?>">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        ?>
                                                                        <button type="button" class="btn btn-success btn-rounded btn-icon" data-toggle="modal" data-target="#eye<?=$id;?>"><i class="feather icon-eye"></i></button>
                                                                    ...
                                                                    <td> 
                                                                        <a href="<?= base_url('Absendosen/map'); ?>/?lat=<?= $data['longtitude'] ?>" target="_blank">
                                                                            <button type="button" class="btn btn-warning btn-rounded btn-icon">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <div class="modal fade" id="edit<?=$id;?>">
                                                                            ...
                                                                            <!-- Modal body -->
                                                                            <form method="post" action="<?= base_url('Absendosen/update'); ?>">
                                                                        ...
                                                                        <div class="modal fade" id="delete<?=$id?>">
                                                                            ...
                                                                            <!-- Modal body -->
                                                                            <form method="post" action="<?= base_url('Absendosen/hapus'); ?>">
                                                                                <div class="modal-body">
...
<?php 
 foreach ($getAbsenmengajar as $data) { 
    $id=$data['id_mengajar'];
    ?>
   <div id="eye<?=$id;?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content modal-lg">
            <div class="modal-body">
                <img src="<?=base_url()?>/image/dosen/<?=$data['foto'];?>" class="img-responsive">
            </div>
        </div>
      </div>
    </div>
