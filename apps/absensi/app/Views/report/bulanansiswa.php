                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-12">
                                            ...
                                            <ul class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a href="<?= base_url($nav); ?>">Bulanan</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        ...
                                        <form method="post" action="<?= base_url('Reportsis/bulanan'); ?>">
                                        ...
                                        <div class="card-header">
                                            <div class="row">
                                                ...
                                                <div class="col-md-auto">
                                                    <a href="<?= base_url('Reportsis/cetakbulanansis'); ?>/?bln=<?=$getBulan;?>" target="_blank">
