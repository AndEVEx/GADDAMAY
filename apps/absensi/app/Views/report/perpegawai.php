                                ...
                                <div class="col-sm-6">
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="row">
                                                <div class="col-10">
                                                <h5>Cari Data Guru/Karyawan</h5>
                                                </div>
                                              
                                            </div>
                                      
                                        </div>
                                        <form method="post" action="<?= base_url('Absensi/perpegawai'); ?>">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <input type="email" class="form-control" value="<?= jummasukbln($getId,date('m')) ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label for="inputEmail3" class="col-sm-5 col-form-label">Terlambat</label>
                                                            <div class="col-sm-7">
                                                                <input type="email" class="form-control" value="<?= jumterlambatbln($getId,date('m')) ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label for="inputEmail3" class="col-sm-5 col-form-label">Sakit</label>
                                                            <div class="col-sm-7">
                                                                <input type="email" class="form-control" value="<?= jumsakitbln($getId,date('m')) ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label for="inputEmail3" class="col-sm-5 col-form-label">Izin</label>
                                                            <div class="col-sm-7">
                                                                <input type="email" class="form-control" value="<?= jumizinbln($getId,date('m')) ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <input type="email" class="form-control" value="<?= jumalphabln($getId, date('m')) ?>">
                                                            </div>
                                                        </div> 
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <input type="email" class="form-control" value="<?= jmlpoint($getId,date('m')) ?>">
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="card-body table-border-style">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <input type="email" class="form-control" value="<?= $getJenisptk ?>">
                                                    </div>
                                                </div>   
                                                <div class="form-group row">
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                ...
                                                for($i=1;$i<=$jumHari;$i++){
                                                    ...
                                                    $sts_absen = sts_absen($getId,$tanggal);
                                                ?>
                                                <div class="col-2">
                                                    <a href="" data-toggle="modal" data-target="#detail<?=$i;?>">
                                                    <div class="card text-white <?php if($sts_absen=="Libur"){?> bg-danger <?php }else{?>bg-primary <?php } ?> mb-3" style="max-width: 10rem;">
