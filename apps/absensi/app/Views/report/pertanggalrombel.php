                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        ...
                                        <form method="post" action="<?= base_url('Reportwal/pertanggal'); ?>">
                                        ...
                                        <div class="card-header">
                                            <div class="row">
                                                ...
                                                <div class="col-md-auto">
                                                    <a href="<?= base_url('Reportwal/printpertanggal'); ?>/?tgl1=<?=$getTanggal1;?>&tgl2=<?=$getTanggal2;?>&idrombel=<?=$idRombel;?>" target="_blank">
