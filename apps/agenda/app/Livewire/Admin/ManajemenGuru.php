...
class ManajemenGuru extends Component
{
    ...
    public function save()
    {
        ...
        if (!$this->editing) $rules['password'] = 'required|min:6';
        $this->validate($rules);
        ...
        if ($this->editing) {
            ...
            $this->dispatch('show-toast', message: 'Guru berhasil diperbarui!', type: 'success');
        } else {
            $user = User::create([
                'name' => $this->nama,
                'email' => $this->email,
            ...
            $this->dispatch('show-toast', message: 'Guru berhasil ditambahkan!', type: 'success');
        }
    ...
    public function deleteUser()
    {
        ...
        $this->dispatch('show-toast', message: 'Guru berhasil dihapus!', type: 'success');
    }
    ...
    public function exportExcel()
    {
        ...
        $filename = 'export_guru_' . date('Y-m-d') . '.xlsx';
